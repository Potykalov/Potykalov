...
- работа с Flexbox;
- основы JavaScript: переменные, числа, строки, условия, функции;
...
### 🪙 [Неткоин — сайт-биржа для крипто-стартапа](https://github.com/potykalov/bjs-diplom)
[▶️ Открыть демо](https://bjs-diplom-kegf.onrender.com)
...
**Стек:** `JavaScript` `Server API` `Node.js` `Git`
