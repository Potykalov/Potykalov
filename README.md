...
**Стек:** `JavaScript` `DOM API` `API` `Node.js` `Express` `lowdb` `Semantic UI` `Git`

**Вывод:**  
Закрепил работу с клиентской логикой, обработкой пользовательских действий, взаимодействием с серверным API, обновлением интерфейса через DOM и обработкой успешных и ошибочных ответов сервера.

---

### ❌⭕ [Игра «Крестики-нолики»](https://github.com/potykalov/tic-tac-toe-js)
[Демо](https://potykalov.github.io/tic-tac-toe-js/)
...
[Демо](https://potykalov.github.io/hangmanGame/)
...
[Демо](https://potykalov.github.io/mq-diploma/)
...
[Демо](https://potykalov.github.io/html-2-diploma/)
